        ...
        <FOOTER>
            <Grid container id="contact" spacing={1}>
                <Grid item xs={12} md={4} className='align-self-center'>
                    <Grid container justifyContent='center'>
                        <Grid item>
                            <Grid container>
                                <Grid item>
                                    <Grid container style={{ justifyContent: 'center', alignItems: 'center', paddingBottom: '0px' }}>
                                        <Grid item>
                                            <h6 style={{ letterSpacing: 1.2, fontWeight: 300, paddingBottom: 20 }}>MULTIVURSE TECHNOLOGIES</h6>
                            ...
                            <Grid container spacing={3} justifyContent='center'>
                                <Grid item>
                                    <Link href='https://github.com/Jonathan-Multivurse' ><img src="/assets/inverted.png" height="100" alt="Upwork"></img></Link>
                                </Grid>
                ...
                <Grid item xs={12} md={5} className='align-self-center'>
                    <address >
                        <p style={{ fontWeight: 300, fontSize: 14, paddingTop: 15, letterSpacing: 0.5 }}>Email: multivurse.technologies@gmail.com</p>
                        <br />
                        <p style={{ fontWeight: 300, fontSize: 13, letterSpacing: 0.6 }}>Contact P.: jonathan2daniels@gmail.com</p>
